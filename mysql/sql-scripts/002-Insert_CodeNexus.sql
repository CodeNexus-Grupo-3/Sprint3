...
INSERT INTO Usuario (nome, nickname, email, senha, telefone, pais, funcao, cargo, fkEquipe) VALUES
    ...
    ('Caio Jose', 'FADC', 'caio.adc@codenexus.com', 'senha123', '11900000000', 'Brasil', 'ADC', 'Jogador', 1),
    -- NexusMasters
    ('Andre Menezes', 'ATop', 'andre.top@codenexus.com', 'senha123', '21999999999', 'Portugal', 'Top', 'Jogador', 2),
    ('Bruno Arruda', 'BMid', 'bruno.mid@codenexus.com', 'senha123', '21988888888', 'Espanha', 'Mid', 'Jogador', 2),
    ('Diego Castro', 'DJungle', 'diego.jungle@codenexus.com', 'senha123', '21977777777', 'Franca', 'Jungle', 'Jogador', 2),
    ('Eduardo Marinho', 'ESup', 'eduardo.sup@codenexus.com', 'senha123', '21966666666', 'Alemanha', 'Sup', 'Jogador', 2),
    ('Fernando Almada', 'FADC2', 'fernando.adc@codenexus.com', 'senha123', '21955555555', 'Italia', 'ADC', 'Jogador', 2);
...
INSERT INTO PartidasEquipe (dtPartida, resultado, duracao, totalAbates, totalAssistencias, totalMortes, totalGold, totalBaron, totalDrag, totalTorres, totalDano, fkEquipe) VALUES
    -- CodeWarriors
    ('2026-04-04', 1, 2400, 25, 40, 20, 60000, 1, 2, 8, 120000, 1),
    ('2026-04-08', 0, 2280, 18, 30, 25, 55000, 0, 1, 6, 100000, 1),
    ('2026-04-12', 1, 2520, 30, 50, 15, 65000, 2, 3, 9, 130000, 1),
    ('2026-04-16', 0, 2700, 20, 35, 28, 58000, 1, 2, 7, 110000, 1),
    ('2026-04-20', 1, 2340, 28, 45, 18, 62000, 2, 2, 10, 125000, 1),
    -- NexusMasters
    ('2026-04-06', 1, 2460, 27, 42, 19, 61000, 1, 2, 9, 122000, 2),
    ('2026-04-10', 0, 2220, 19, 33, 26, 54000, 0, 1, 6, 98000, 2),
    ('2026-04-14', 1, 2580, 32, 55, 14, 67000, 2, 3, 9, 135000, 2),
    ('2026-04-18', 0, 2760, 21, 36, 29, 59000, 1, 2, 7, 112000, 2),
    ('2026-04-22', 1, 2280, 29, 47, 17, 63000, 2, 2, 10, 127000, 2);